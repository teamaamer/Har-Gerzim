  ...
  return (
    <footer className="border-t bg-gradient-to-b from-navy-900 to-navy-950 text-white">
      <div className="w-full px-4 md:px-6 lg:px-8 max-w-7xl mx-auto py-12 md:py-16">
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-12">
          {/* Mobile: Company info takes 2 columns */}
          <div className="space-y-6 col-span-2 lg:col-span-1">
            ...
            {/* Mobile Layout - Contact info only */}
            <div className="lg:hidden space-y-3 text-sm text-gray-300">
            ...
            {/* Desktop Layout - Original layout with social buttons below */}
          ...
          <div className="lg:hidden flex flex-col gap-3 items-center justify-center">
            ...
            <a 
              href="#" 
              className="w-12 h-12 rounded-lg bg-white/10 hover:bg-blue-600 flex items-center justify-center transition-all duration-300"
              aria-label="Facebook"
            >
            ...
            <a 
              href="#" 
              className="w-12 h-12 rounded-lg bg-white/10 hover:bg-pink-600 flex items-center justify-center transition-all duration-300"
              aria-label="Instagram"
            >
