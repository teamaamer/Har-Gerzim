...
import { getProducts, getCollectionsWithProducts, getAllCollections } from '@/lib/shopify';
...
export default async function HomePage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  const heroCollections = await getAllCollections(6, locale);

  return (
    <>
      <main id="main-content" className="flex flex-col">
        <section id="home">
          <HeroSection locale={locale} dict={dict} products={products} collections={heroCollections} />
        </section>
